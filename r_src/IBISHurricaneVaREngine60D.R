IbisHurricaneVaREngine60D <- function() {
  ...
  positions <- read.csv(file = "\\\\10.45.95.15\\public\\Hurricane\\Ibis\\RVaR\\positions.csv") 
  riskfactors <- read.csv(file = "\\\\10.45.95.15\\public\\Hurricane\\Ibis\\RVaR\\prices.csv")
  riskfactors <- tail(riskfactors,60)
  ...
  write.csv(VaR_Data,paste0("\\\\10.45.95.15\\public\\Hurricane\\Ibis\\RVaR\\VaR_Data.csv"), row.names = FALSE)
  write.csv(VaR_Data,paste0("\\\\10.45.95.15\\public\\Hurricane\\Ibis\\RVaR\\VaR_Data_",tradedate,".csv"), row.names = FALSE)  
}
